...
public class GreenDaoGenerator {
    ...
    public static final String GREEN_DAO_CODE_PATH = "../FrameProjMVVM/app/src/main/java";

    public static void main(String[] args) throws Exception {
        Schema schema = new Schema(VERSION, "com.android.mvvm.frameprojmvvm.db");
